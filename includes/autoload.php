 ...
 * Autoloader
 *
 * @package advanceContentController
 */
...
if (!function_exists('advanceContentControllerAutoload')) {
    /**
     * Plugin autoloader.
     *
     ...
     * @param $class
     */
    function advanceContentControllerAutoload($class)
    {
        // Do not load unless in plugin domain.
        $namespace = 'advanceContentController';
    ...
    spl_autoload_register('advanceContentControllerAutoload');
}
